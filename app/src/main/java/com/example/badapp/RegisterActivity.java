...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextFullname = findViewById(R.id.editTextSpecialty);
        editTextEmail = findViewById(R.id.editTextYearsExperience);
        editTextBirthDate = findViewById(R.id.editTextNumPatient);
